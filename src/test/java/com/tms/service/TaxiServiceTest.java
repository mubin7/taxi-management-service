...
@Testcontainers
@SpringBootTest
public class TaxiServiceTest extends BasePostgresIntegrationTest {
    ...
    public void whenCreateTaxi_thenReturnTaxi() {
        ...
        CreateTaxiRequest createTaxiRequest = TaxiServiceTestHelper.createTaxiRequest(xPosition, yPosition);
    ...
    public void whenCreateTaxiWithEmptyXPosition_thenThrowsTaxiCreationException() {
        double yPosition = 0.0;
        CreateTaxiRequest createTaxiRequest = TaxiServiceTestHelper.createTaxiRequest(null, yPosition);
        assertThrows(TaxiCreationException.class, () -> taxiService.createTaxi(createTaxiRequest));
    }
    ...
    public void whenCreateTaxiWithEmptyYPosition_thenThrowsTaxiCreationException() {
        double xPosition = 0.0;
        CreateTaxiRequest createTaxiRequest = TaxiServiceTestHelper.createTaxiRequest(xPosition, null);
        assertThrows(TaxiCreationException.class, () -> taxiService.createTaxi(createTaxiRequest));
    }
